...
- Open WebUI vous demandera de créer un compte administrateur local. Une fois connecté, vous verrez l'interface de clavardage.
...
2. Dans le panneau des paramètres, cliquez sur **Admin Settings** en bas à gauche.
...
2. Cliquez sur le bouton **`+`** dans la boîte de message et téléversez une image
...
Affichez directement les sorties HTML dans l'interface. C'est étonnamment puissant pour créer rapidement des prototypes, des rapports formatés et des extraits interactifs. [Référence](https://lemonade-server.ai/docs/server/apps/open-webui/#html-rendering)
