...
Le modèle suivant doit être accessible au Lemonade Server avant de démarrer le
playbook.

| Type de modèle | ID du modèle | Remarques |
| --- | --- | --- |
| Modèle de clavardage GGUF | `Qwen3.6-35B-A3B-GGUF` | Servi par Lemonade Server sur `http://127.0.0.1:13305/api/v1`. Utilisez un modèle GGUF plus petit sur les appareils disposant de moins de 32 Go de mémoire. |
